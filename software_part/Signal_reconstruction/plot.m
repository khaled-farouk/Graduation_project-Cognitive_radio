...
semilogy(mean(err_msbl2,1),'linewidth',2.5);
hold on;semilogy(mean(err_msbl5,1),'-.','linewidth',2.5);
legend('M-SBL steps by 2','M-SBL steps by 5');
ylabel('\bf\fontsize{20}MSE');
